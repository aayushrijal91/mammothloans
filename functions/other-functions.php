...
function echo_theme_image($relative_url, $alt = '', $class = '')
{
    $url = get_template_directory_uri() . '/assets/images' . $relative_url;
    $alt_text = empty($alt) ? get_bloginfo('name'): $alt;  // Default alt text is site name
